...
export function Footer(config: CodedocConfig, renderer: any) {
  return <_Footer>
    ...
    <iframe src="https://github.com/sponsors/evant/button" title="Sponsor evant" height="35" width="30" style="border: 0; flex: 0; min-width: 120px; background: transparent"></iframe>
  </_Footer>;
}
